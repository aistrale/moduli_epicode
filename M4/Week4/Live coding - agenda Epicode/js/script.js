// In questo script andremo a implementare il CRUD sull'endpoint dell'Agenda di EPICODE.
...
async function getAgenda() {
    ...
    try {
        ...
        const response = await fetch(ENDPOINT) // la variabile response crea una variabile "data"
        const data = await response.json() // la variabile "data" è a sua volta una promessa con i risultati
        return data // questa è la risoluzione della promessa
    } catch (error) {
        console.log('here')
        console.error(error)
